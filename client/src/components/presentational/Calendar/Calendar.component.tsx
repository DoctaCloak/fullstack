...
/**
 * NOTE: THIS IS SOURCED FROM THE MATERIAL UI CALENDAR DOCUMENT COMPONENT
 */
...
const Calendar = ({onCalendarChange, shouldDisableDate}) => {
  ...
  function onStaticDatePickerChange(date: any) {
    setValue(date);
        ...
        <Fade in timeout={700}>
          ...
          >
            <StaticDatePicker
              ...
              value={value}
              onChange={onStaticDatePickerChange}
