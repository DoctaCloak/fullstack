 ...
 * @internal
 */
const IS_DEV_SERVER_MODE = process.argv.some(arg =>
...
exports.createDefinePlugin = environment => {
  ...
  console.log(envConfig, envFilePath);
 ...
 * @returns {string}
 */
exports.getOutputPublicPath = environment =>
  IS_DEV_SERVER_MODE ? '' : OutputPublicPathMap[environment];
